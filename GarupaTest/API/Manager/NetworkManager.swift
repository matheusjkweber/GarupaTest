...
class NetworkManager {
    fileprivate let router = Router<GarupaEndpoint>()
    
    func request<T: Codable>(request: GarupaEndpoint,
    ...
    func request(request: GarupaEndpoint,
    ...
    func requestData(request: GarupaEndpoint,
